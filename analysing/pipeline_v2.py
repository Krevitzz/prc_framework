...
Enchaînement :
    ...
    5. compute_projection(M_ortho)  ← si plot (t-SNE ou UMAP selon seuil)
...
from analysing.profiling_v2    import run_profiling
from analysing.outliers_v2  import analyze_outliers
from analysing.clustering_v2 import prepare_matrix, compute_projection, run_clustering
from analysing.cluster_namer_v2  import ClusterNamer
from analysing.visualizer_v2        import ClusterVisualizer
...
def run_analysing_pipeline(
    ...
    if plot and output_dir:
        ...
        M_2d       = compute_projection(M_ortho, cfg=cfg.get('projection', {}), cache_path=proj_cache)
    ...
    verbose = cfg.get('peeling', {}).get('verbose', False)
