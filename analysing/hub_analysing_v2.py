...
from analysing.parquet_filter_v2 import load_analysing_data, AnalysingData
from analysing.pipeline_v2       import run_analysing_pipeline
from analysing.verdict_v2        import write_verdict_report, write_verdict_report_txt
...
def run_verdict_from_parquet(
    ...
    Flux :
        charge cfg YAML
        → load_analysing_data(parquet_path, scope, apply_pool)
        → run_analysing_pipeline(data, cfg, ...)
...
def run_verdict_cross_phases(
    ...
    phases_data    : Dict[str, AnalysingData] = {}
    ...
    concordance = run_concordance_cross_phases(phases_data)
